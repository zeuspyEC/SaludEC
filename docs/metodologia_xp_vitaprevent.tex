...
\begin{enumerate}
  ...
  \item \textbf{Las iteraciones cortas aceleraron la retroalimentación:} Cuatro sub-iteraciones de pocas horas cada una permitieron detectar y corregir tres problemas de accesibilidad (orden de foco WCAG 2.4.3, alt vacíos WCAG 1.1.1, contraste en tablas WCAG 1.4.3) antes de que se acumularan.
